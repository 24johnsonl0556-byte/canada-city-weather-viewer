var city;
const cityget = document.getElementById("submitbuttion"); // city name
const chosencity = document.getElementById("select1"); //cap city txt placement
const city1 = document.getElementById("var1");   //tempture
const city2 = document.getElementById("var2");   //wind
const city3 = document.getElementById("var3");   //humidity
cityget.addEventListener('click', function(evt){ // this function extracts the name of the dropdown city chosen.
    evt.preventDefault();
    let text = document.getElementById('cityname').value;//text is city name.
...
async function nametogeo(a){ //every part of this works 
    ...
    try {
        ...
        //erorr happened here.
        city1.textContent = temp;
        city2.textContent = wind;
        city3.textContent = humid;
        //
